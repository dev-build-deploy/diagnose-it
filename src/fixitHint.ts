 ...
 * ```
 */
export type ModificationType = "INSERT" | "REMOVE" | "REPLACE";
 ...
 *
 * @class FixItHint
 * @member modification Modification type (INSERT, REMOVE, REPLACE)
...
export class FixItHint {
  ...
  /**
   * @param modification Modification type (INSERT, REMOVE, REPLACE)
